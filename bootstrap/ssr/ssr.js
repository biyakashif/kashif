...
const appName = "Kashif";
createServer(
  (page) => createInertiaApp({
    page,
    render: renderToString,
    title: (title) => `${title} - ${appName}`,
    resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-BxCaD4q_.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-B3z22f-K.js"), "./pages/auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-B_wHfLIK.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-DAno8w-N.js"), "./pages/auth/Login.vue": () => import("./assets/Login-DC-3eIdc.js"), "./pages/auth/Register.vue": () => import("./assets/Register-rCtfeeSO.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-DiAQw9uQ.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-Bd64miAh.js"), "./pages/settings/Appearance.vue": () => import("./assets/Appearance-DPSUVZeP.js"), "./pages/settings/Password.vue": () => import("./assets/Password-CEcPRpCp.js"), "./pages/settings/Profile.vue": () => import("./assets/Profile-emhYpXhJ.js") })),
    setup({ App, props, plugin }) {
      var _a;
      const ziggyConfig = (_a = page.props) == null ? void 0 : _a.ziggy;
      return createSSRApp({ render: () => h$1(App, props) }).use(plugin).use(U, ziggyConfig ? {
        ...ziggyConfig,
